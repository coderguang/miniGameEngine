...
private:
    ...
    struct ErrorInfo {
        ...
        static ErrorInfo* create(ErrorCodes::Error code, const StringData& reason, int location);
...
MONGO_CLIENT_API inline bool MONGO_CLIENT_FUNC
operator==(const ErrorCodes::Error lhs, const Status& rhs);
