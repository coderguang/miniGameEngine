...
// NOTE: parser-impl.h MUST be included after parser.h
// and all geometry type files. This is a workaround to a circular dependency
// issue between parser.h and geometrycollection.h. See
// file comments in parser-impl.h for details.
