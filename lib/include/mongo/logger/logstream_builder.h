...
public:
    static LogSeverity MONGO_CLIENT_FUNC severityCast(int ll) {
        return LogSeverity::cast(ll);
    }
    static LogSeverity MONGO_CLIENT_FUNC severityCast(LogSeverity ls) {
        return ls;
    }
    static LabeledLevel MONGO_CLIENT_FUNC severityCast(const LabeledLevel& labeled) {
        return labeled;
    }
